...
namespace EtlKit.ControlFlow.SqlServer
{
    ...
    /// </example>
    [PublicAPI]
    public class CleanUpSchemaTask : GenericTask
    {
        /* ITask Interface */
...
";
        ...
        public static void CleanUp(string schemaName) =>
            new CleanUpSchemaTask(schemaName).Execute();

        public static void CleanUp(IConnectionManager connectionManager, string schemaName) =>
            new CleanUpSchemaTask(schemaName) { ConnectionManager = connectionManager }.Execute();
